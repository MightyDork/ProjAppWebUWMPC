...
CREATE TABLE `produkt` (
  ...
  `gabaryt_produktu` varchar(10) NOT NULL,
...
INSERT INTO `produkt` (`id`, `tytul`, `opis`, `data_utworzenia`, `data_modyfikacji`, `data_wygasniecia`, `cena_netto`, `podatek_vat`, `ilosc_w_magazynie`, `status`, `kategoria`, `gabaryt_produktu`, `zdjecie`) VALUES
(2, 'Produkt 1', 'Opis 1', '2025-01-20', '2025-01-23', '2025-01-20', 19.99, 3, 5, 'W magazynie', 12, '33', 0x696d672f77322e6a7067),
(4, 'Produkt 2', 'Opis 2', '2025-01-20', '2025-01-23', '2025-01-20', 20.99, 9, 10, 'W magazynie', 1, '10', 0x667265652d706e672d746573742d746573742d7061737365642d69636f6e2d313630302e706e67),
(5, 'Produkt 3', 'Opis P3', '2025-01-23', '2025-01-23', '2025-02-07', 23, 1, 13, 'W magazynie', 13, '3', 0x696d672f77312e6a7067);
